...
help = "Usage: python3 generate_main.py <maxBlocksToReveal>"
if (len(sys.argv)) <= 1:
    print(help)
    exit(-1)

maxBlocksToReveal = sys.argv[1]

main_generated = """pragma circom 2.0.0;
...
component main {public [ ciphertext, nonce, starting_aes_block, bytes_to_reveal ]} = Main("""
main_generated += maxBlocksToReveal + ");"

with open('main_generated.circom', 'w') as f:
    print(main_generated, file=f)

print("file main_generated.circom generated succesfully")
